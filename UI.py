...
def process_inputs(audio_filepath, image_filepath):
    speech_to_text_output = transcribe_audio(GROQ_API_KEY=os.environ.get("GROQ_API_KEY"),  audio_filepath=audio_filepath, stt_model="whisper-large-v3")
    ...
    voice_of_doctor = text_to_speech_with_elevenlabs(text=doctor_response, output_filepath="final.mp3") 
